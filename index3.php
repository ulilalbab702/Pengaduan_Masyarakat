              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Login sebagai Admin atau Petugas !</h1><h4 class="h5 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat Temanggung</h4>
                  </div>
                  <form class="user" method="post" action="cek_login2.php">
                    ...
                    <hr>
                    <div class="text-center">
                    <a class="small" href="register2.php" style="color: darkorange;">Daftar Sebagai Admin</a>
                  </div>
                  <hr>
                  </form>
                </div>
